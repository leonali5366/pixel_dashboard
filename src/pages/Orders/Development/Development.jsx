...
const Development = () => {
  ...
  const stats = {
    ...
    completedOrders: 75,
    canceledOrders: 10,
    revenue: 45000, // in USD
    ongoingRevenue: 15000,
  };

  const orders = [
    { id: 1, client: "John Doe", service: "WordPress", status: "Ongoing", amount: 500 },
    { id: 2, client: "Jane Smith", service: "Shopify", status: "Completed", amount: 800 },
    { id: 3, client: "Alan Brown", service: "Wix", status: "Canceled", amount: 0 },
    // Add more dummy data
  ];
