...
const Wordpress = () => {
    const { orders, wordpressOrders } = useOrders();
    ...
    useEffect(() => {
      calculateStats(wordpressOrders);
    }, [wordpressOrders]);
  ...
  const calculateStats = (ordersData) => {
    ...
    const table = useReactTable({
      data: wordpressOrders,
      columns,
      pageCount: Math.ceil(wordpressOrders.length / 5),
      initialState: {
        pagination: {
          pageSize: 5,
          pageIndex: 0,
    ...
    return (
      <div className="p-6 space-y-6">
        {/* Page Title */}
        <h1 className="text-2xl font-bold text-gray-800">Wordpress Dashboard</h1>
