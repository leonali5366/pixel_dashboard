...
const Wix = () => {
    const { orders, wixOrders } = useOrders();
  ...
  const calculateStats = (ordersData) => {
    ...
    const table = useReactTable({
      data: wixOrders,
      columns,
      pageCount: Math.ceil(wixOrders.length / 5),
      initialState: {
        pagination: {
          pageSize: 5,
          pageIndex: 0,
    ...
    return (
      <div className="p-6 space-y-6">
        {/* Page Title */}
        <h1 className="text-2xl font-bold text-gray-800">Wix Dashboard</h1>
